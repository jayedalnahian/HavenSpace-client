    ...
    return (
      ...
      >
        <div className="text-center max-w-md">
          <h2 className="text-2xl font-bold text-main mb-4">Your wishlist is empty</h2>
          <p className="text-gray-600 mb-6">Start exploring properties and save your favorites to your wishlist.</p>
          <button 
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center space-x-4">
          <span className="text-gray-600">{wishlist.length} {wishlist.length === 1 ? 'property' : 'properties'}</span>
          <select 
            value={sortBy}
            ...
            >
              ...
              <div className="p-5">
                <div className="flex justify-between items-start">
                  <h3 className="text-lg font-bold text-main mb-1">{property.title}</h3>
