...
const LoginPage = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            showSuccessAlert("Login Successful!", "You've been logged in successfully");
    ...
    const handleGoogle = async () => {
        ...
        try {
            await googleLogin();
            showSuccessAlert("Login Successful!", "You've been logged in with Google");
            navigate("/browse-tasks");
        } catch (error) {
            console.error(error);
        ...
        >
            <div className="w-full max-w-md bg-[#FFFBDE] rounded-2xl shadow-xl overflow-hidden border border-[#91C8E4]/50">
                <div className="bg-gradient-to-r from-[#4682A9] to-[#749BC2] p-6 text-center">
                    ...
                    <p className="text-[#FFFBDE]/90 mt-1">Sign in to access your economic insights</p>
                </div>

                <div className="p-6">
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div className="space-y-1">
                            <label className="block text-sm font-medium text-[#4682A9]">Email</label>
                        ...
                        <div className="space-y-1">
                            <label className="block text-sm font-medium text-[#4682A9]">Password</label>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-[#FFFBDE] text-[#749BC2]">Or continue with</span>
                            </div>
                        </div>
